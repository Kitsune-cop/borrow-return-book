                    ...
                    <div class="row">
                        ...
                        while ($row = mysqli_fetch_array($res_data)) {
                            if ($row['bName'] == "กำลังยืม") {
                                ...
                                echo "  <td><button class='btn btn-primary'><a style=text-decoration:none;color:White; href=return_book.php?borrowID=".$row['borrowID'].">คืน</a></button></td>";
                                echo "  </tr>";
                                echo "</tbody>";
                            } else {
                                $imageURL = 'assets/img/book/' . $row['bookIMG'];
