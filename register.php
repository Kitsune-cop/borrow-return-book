...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($objResult) {
            ...
            $sql = "INSERT INTO member (FirstName, LastName, Gender, BirthDate, Tel, Username, Password, Email,statusmem)VALUES ('" . $_POST["fname"] . "','" . $_POST["lname"] . "','" . $_POST["gender"] . "','" . $_POST["dob"] . "','" . $_POST["phone"] . "','" . $_POST["username"] . "','" . $_POST["password"] . "','" . $_POST["email"] . "','MEMBER') ";
                ...
                <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <button class="btn btn-warning"><a style="color:White; text-decoration: none;"href="index.php.php">Go Back</a></button>
                        </div>
                    </div>
                </form>
            </div>
